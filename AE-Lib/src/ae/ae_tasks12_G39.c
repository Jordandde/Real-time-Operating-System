...
void task0(void)
{
    ...
    for(int i = 0; i < 5; i++){
        ...
        //test 0-[7:11]
        (*p_index)++;
        printf(g_ae_xtest.msg, "task0: send_msg to tid(%u) in a loop, iteration %d\n", g_tids[1], i);
...
{  
    ...
    while(counter < 4){
        ...
        (*p_index)++;
        U8 buffer[BUF_LEN];
        sprintf(g_ae_xtest.msg, "task1: recv_msg_nb in real-time, iteration %d\n", counter);
...
void task2(void)
{
    ...
    while(counter < 5){
        ...
        (*p_index)++;
        U8 buffer[BUF_LEN];
        sprintf(g_ae_xtest.msg, "task2: recv_msg in a real-time, iteration %d\n", counter);
...
void task3(void)
{
    ...
    (*p_index)++;
    sprintf(g_ae_xtest.msg, "task3: send_msg to tid(%u)\n", g_tids[2]);
    ...
    while(counter < 4){
        ...
        (*p_index)++;
        sprintf(g_ae_xtest.msg, "task3: send_msg to tid(%u) in real-time, iteration %d\n", g_tids[2], counter);
